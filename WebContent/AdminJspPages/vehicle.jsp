...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="Table col-md-12">
			...
			<div class="Heading">
				<div class="Cell">
					<p class="p">Vehicle No</p>
				</div>
				<div class="Cell">
					<p class="p">Vehicle Type</p>
				</div>
				<div class="Cell">
					<p class="p">Driver</p>
				</div>
				<div class="Cell">
					<p class="p">Vehicle State</p>
				</div>
				<div class="Cell">
					<p class="p">Action</p>
				</div>
			...
			<%
				List<Vehicle> vehicleList = (List<Vehicle>) request.getAttribute("data");
			%>
			<%
			...
			<div class="Row" style="background-color: white;">
				<div class="Cell">
					<b style="color: #a27311"><%=vehicle.getVehicleNo()%></b>
				</div>
				<div class="Cell">
					<b style="color: #a27311"><%=vehicle.getVehicleType()%></b>
				</div>

				<div class="Cell">
					<b style="color: #FF6347">Name</b>: <b style="color: #a27311"><%=vehicle.getEmployee().getEmployeeName()%></b>
				</div>
				<div class="Cell">
					<b style="color: #a27311"><%=vehicle.getVehicleFlag()%></b>
				</div>
				<div class="Cell">
